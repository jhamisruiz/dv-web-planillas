                    ...
                    <div class="row p-4">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="Nombre categoria" class="form-control">
                            </div>
                            <label>Descripción: </label>
                            <div class="form-group">
                                <textarea name="" id="" class="form-control" cols="12" rows="3" placeholder="Descrip. categoria"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
